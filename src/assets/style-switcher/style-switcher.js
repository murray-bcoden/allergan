...
function createLESS() {
  $('head').append($('<link rel="stylesheet/less">').attr('href', window.location.protocol + '//' + window.location.host + '/assets/include/less/themes/custom.less'));
}

function createLESSJS() {
  var script = document.createElement('script');
  script.src = window.location.protocol + '//' + window.location.host + '/assets/style-switcher/vendor/lessjs/less.min.js';
